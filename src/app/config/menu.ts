							...
							items: [
								{
									...
									submenu: {
										...
										items: [
											...
											{
												title: 'Empresas',
												page: '/ecommerce/empresas',
												icon: 'flaticon-interface-1',
											},
											{
												title: 'Empleados',
												page: '/ecommerce/empleados',
												icon: 'flaticon-interface-1',
											},
											{
												title: 'Multas',
												page: '/ecommerce/multas',
												icon: 'flaticon-interface-1',
											},
											{
												title: 'Descuentos',
												page: '/ecommerce/descuentos',
												icon: 'flaticon-interface-1',
											},
											{
												title: 'Horas Extra',
												page: '/ecommerce/horas',
												icon: 'flaticon-interface-1',
											},
											{
												title: 'Domingos & Feriados',
												page: '/ecommerce/domingos',
												icon: 'flaticon-interface-1',
											},
											{
												title: 'Bonos',
												page: '/ecommerce/bonos',
												icon: 'flaticon-interface-1',
											},
											{
												title: 'Form 110',
												page: '/ecommerce/rcivas',
												icon: 'flaticon-interface-1',
											},
											{
												title: 'Products',
